...
public class Window2 implements ActionListener{
    ...
    public static void main(){
        ...
        label = new JLabel("Exchange foreign currency to USD:");
        ...
        label2 = new JLabel("Enter the 3 letter currency abbreviation you are exchanging from:");
        label2.setBounds(10,90,425,50);
        panel.add(label2);
        ...
        button.addActionListener(new Window2());
